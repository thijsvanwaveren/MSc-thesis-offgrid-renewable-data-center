...
# =============================================================================
# MAIN SWEEP (UPDATED WITH CAPACITY BOUNDARIES)
# =============================================================================
...
def run_3d_feasible_sweep(target_rel=99.9):
    ...
    MAX_IT_CAPACITY_MW = 30.0  # Set your desired data center size here
    MIN_UTILIZATION_PCT = 0.0 # 40% minimum target
    ...
    for a_mw in tier_a_array:
        ...
        for b1_mw in tier_b1_array:
            ...
            if b1_mw > max_b1_ceiling:
                print(f"   ⏭️ Skip B1={b1_mw:.1f} (above ceiling {max_b1_ceiling:.1f})")
                continue
            ...
            for b2_mw in tier_b2_array:
                ...
                if is_viable:
                    ...
                    print(f"      ⏭️ Break B2 loop for (A={a_mw:.1f}, B1={b1_mw:.1f})")
                    break
            ...
            if pair_has_any_viable_b2:
                ...
                # PRUNING RULE C
                print(f"   ⏭️ Break B1 loop at A={a_mw:.1f} because no feasible B2 existed for B1={b1_mw:.1f}")
                break
