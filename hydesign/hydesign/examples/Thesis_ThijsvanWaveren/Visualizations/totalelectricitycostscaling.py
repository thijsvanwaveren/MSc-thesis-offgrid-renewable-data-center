# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 16:56:55 2026
...
# =============================================================================
var_cost_data = []
print("Calculating Variable Cost Breakdown (Stacked Area Chart)...")
...
ax.set_xlabel("Installed IT Capacity (MW)", fontsize=11, fontweight='bold', color='#222222')
