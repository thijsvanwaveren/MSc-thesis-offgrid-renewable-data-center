"""
Calculate financial performance of the optimal workload mixes in 
various data center sizes

Reads all Feasible_3D_Sweep_Results_99.9pct_IT*.csv files, filters for Tier A >= 8 MW, 
and applies the master thesis macroeconomic calculation engine to find
