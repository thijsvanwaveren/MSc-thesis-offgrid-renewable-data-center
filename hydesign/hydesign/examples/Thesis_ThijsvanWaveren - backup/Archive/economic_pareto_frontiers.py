# -*- coding: utf-8 -*-
"""
Economic Pareto Frontiers (Strictly Excluding Tier C)
Generates two 2x3 grid visualizations analyzing workload mix trade-offs:
1. Contribution Margin vs. Energy Delivered
2. Average Capture Price vs. Energy Delivered
...
# Tier C is intentionally excluded from revenue
REVENUE_PER_MWH = {
    "A": 3000.0,
    "B1": 2100.0,
    "B2": 1200.0
...
# =============================================================================
# 2. DATA PROCESSING (STRICTLY COMMITTED LOADS)
# =============================================================================
all_scenarios = {}
...
for cap in IT_CAPACITIES_MW:
    ...
    # Convert GWh to MWh for calculations
...
def plot_pareto_grid(x_col, y_col, x_label, y_label, title, filename):
    ...
    and high-contrast color-coding based on Average Deferral Time.
    """
    ...
    for idx, cap in enumerate(IT_CAPACITIES_MW):
        ...
        scatter = ax.scatter(df[x_col], df[y_col], 
                             ...
                             cmap=cmap, s=15, alpha=0.8, edgecolors='none')
...
# PLOT 1: Contribution Margin vs Energy Delivered
plot_pareto_grid(
    ...
    title="Economic Envelope: Energy Capture vs. Contribution Margin (Excluding Tier C)", 
    filename="Thesis_Pareto_Margin_vs_Energy.png"
)

# PLOT 2: Average Price vs Energy Delivered
plot_pareto_grid(
    x_col="Energy_Delivered_No_C_GWh", 
    y_col="Average_Capture_Price_No_C", 
    x_label="Committed Energy Delivered (GWh/yr)", 
    y_label="Average Capture Price (€/MWh)", 
    title="Pricing Frontier: Energy Volume vs. Average Capture Price (Excluding Tier C)", 
    filename="Thesis_Pareto_Price_vs_Energy.png"
)
