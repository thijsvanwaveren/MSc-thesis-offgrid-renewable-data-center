...
def run_firm_yield_analysis():
    ...
    MAX_IT_CAPACITY_MW = 500.0  # Plentiful headroom for catching up!
    N_life = 25 * 8760
    ...
    # Generate the weekly breakdown plot
    plot_weekly_dynamic_capacity(hpp_overload.prob, OVERLOAD_A_MW, OVERLOAD_IT_MW)
